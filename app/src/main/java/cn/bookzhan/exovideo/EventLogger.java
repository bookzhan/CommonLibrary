 ...
 */
public class EventLogger implements PlayerManager.Listener, PlayerManager.InfoListener,
    PlayerManager.InternalErrorListener {
  ...
  public EventLogger() {
    loadStartTimeMs = new long[PlayerManager.RENDERER_COUNT];
  }
