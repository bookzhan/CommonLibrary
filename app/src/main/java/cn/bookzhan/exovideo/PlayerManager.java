 ...
 */
public class PlayerManager implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link PlayerManager#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link PlayerManager#onRenderersError} should be invoked.
     */
    void buildRenderers(PlayerManager player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link PlayerManager#onRenderers} or
     * {@link PlayerManager#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
  ...
  public PlayerManager(RendererBuilder rendererBuilder) {
   ...
   *
   * @param renderers Renderers indexed by {@link PlayerManager} TYPE_* constants. An individual
