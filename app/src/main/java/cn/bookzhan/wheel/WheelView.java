...
/**
 * Numeric wheel cn.bookzhan.view.
 * 
...
public class WheelView extends View {
	 ...
	 * To apply changes and rebuild cn.bookzhan.view call measure().
	 * 
	...
	/**
	 * Gets cn.bookzhan.view adapter
	 * @return the cn.bookzhan.view adapter
	 */
	...
	/**
	 * Sets cn.bookzhan.view adapter. Usually new adapters contain different views, so
	 * it needs to rebuild cn.bookzhan.view by calling measure().
	 * 
	 * @param viewAdapter the cn.bookzhan.view adapter
	 */
	...
	/**
	 * Updates cn.bookzhan.view. Rebuilds items and label if necessary, recalculate items sizes.
	 */
	...
	/**
	 * Builds cn.bookzhan.view for measuring
	 */
	...
	/**
	 * Adds cn.bookzhan.view for item to items layout
	 * @param index the item index
	 * @param first the flag indicates if cn.bookzhan.view should be first
	...
	/**
	 * Returns cn.bookzhan.view for specified item
	 * @param index the item index
	 * @return item cn.bookzhan.view or empty cn.bookzhan.view if index is out of bounds
	 */
