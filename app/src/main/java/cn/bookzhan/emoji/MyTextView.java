...
//	private float lineSpacingMult = 0.5f;
    ...
    public MyTextView(Context context) {
        ...
        lineSpacing = DisplayUtil.dip2px(context, lineSpacingDP);
        minHeight = 0;
...
//        }
        ...
        for (int i = 0; i < lineNum; i++) {
            ...
            for (int j = 0; j < line.line.size(); j++) {
                ...
                if (ob instanceof String) {
                    ...
                    int top = (int) height+ DisplayUtil.dip2px(context,4f);
                    int right = (int) (realDrawedWidth + width);
                    int bottom = (int) (height + line.height+DisplayUtil.dip2px(context,4f));
    ...
    private int measureContentHeight(int width) {
        ...
        if(contentList.size()==1){
            height=height-DisplayUtil.dip2px(context,9f);
        }else {
            height=height-DisplayUtil.dip2px(context,3.5f);
        }
        return (int) height;
    }
