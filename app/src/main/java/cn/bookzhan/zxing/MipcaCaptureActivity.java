...
public class MipcaCaptureActivity extends Activity implements Callback {
    ...
    /**
     * 处理扫描结果
     * 如果是扫描失败的话可以使用handler.sendEmptyMessageDelayed(R.id.restart_preview,3000);再次扫描
     *
     * @param result
     * @param barcode
     */
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            ToastUtils.showToastAtCenter(this,"扫描失败");
            handler.sendEmptyMessageDelayed(R.id.restart_preview, 3000);
            return;
        }else {
            ToastUtils.showToastAtCenter(this,resultString);
            handler.sendEmptyMessageDelayed(R.id.restart_preview, 3000);
