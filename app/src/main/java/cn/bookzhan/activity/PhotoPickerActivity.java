...
import cn.bookzhan.utils.ImagePickerUtil;
import cn.bookzhan.utils.ImageUtils;
...
public class PhotoPickerActivity extends BaseActivity {
    ...
    protected void pickImage(final int requestCode) {
        ...
        builder.setItems(actions, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        ImagePickerUtil.openPhotoAlbums(PhotoPickerActivity.this, requestCode);
                        break;
                    case 1:
                        captureImageFile = ImagePickerUtil.openCamera(PhotoPickerActivity.this, requestCode);
                        break;
                    default:
                        break;
                }
    ...
    private void deletePhotoConfirm(final int viewId, final int defautResouceId) {
        ...
        //        builder.setIcon(totem.common.R.mipmap.ic_launcher);
        builder.setCancelable(true);
